...
public class SpelledSimilarly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spelled_similarly);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        String word = getIntent().getExtras().getString("word");

        TextView infoTextView = (TextView)findViewById(R.id.text6);
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                try {
                    URL Datamuse = new URL("https://api.datamuse.com/words?sp="+word2);
                ...
                String rhyme = "Spelled similarly to your word:"+"\n";
                for (String s : results){
                    rhyme = rhyme + s +", ";
                }
                rhyme = rhyme + word2 +"(Your word).";
                TextView infoTextView2 = findViewById(R.id.text7);
    ...
    public void onClick11(View v1) {
        ...
        TextView infoTextView = findViewById(R.id.text22);
        if(results.size() >= 0) {
